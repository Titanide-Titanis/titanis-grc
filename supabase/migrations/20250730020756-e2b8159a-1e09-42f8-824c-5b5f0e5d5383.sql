-- Update subscription tiers with new pricing structure
UPDATE subscription_tiers 
SET 
  name = 'Demo',
  description = 'Free demonstration mode with limited features',
  price_monthly = 0,
  price_yearly = 0,
  features = '{"core_modules": true, "demo_mode": true, "limited_users": 2}',
  limits = '{"admin_users": 2, "read_only_users": 5, "frameworks": 1}'
WHERE name = 'Free';

UPDATE subscription_tiers 
SET 
  name = 'Trial',
  description = '14-day free trial with full access to evaluate the platform',
  price_monthly = 0,
  price_yearly = 0,
  features = '{"core_modules": true, "trial_mode": true, "full_access": true}',
  limits = '{"admin_users": 5, "read_only_users": "unlimited", "frameworks": 2, "trial_days": 14}'
WHERE name = 'Basic';

-- Insert new Starter tier
INSERT INTO subscription_tiers (name, description, price_monthly, price_yearly, features, limits, stripe_price_id_monthly, stripe_price_id_yearly)
VALUES (
  'Starter',
